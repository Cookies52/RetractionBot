...
class Database:
    def __init__(self, db_settings: dict[str, str]):
        self._db = pymysql.connect(host=db_settings["host"],
                     db=db_settings["name"],
                     read_default_file=os.path.expanduser("~/replica.my.cnf"))

    def save_retraction_to_db(self, timestamp, origin, original_doi, retraction_doi, original_pmid, retraction_pmid, retraction_nature, url):
        """
